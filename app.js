...
function productCardHtml(p, opts){
  ...
  var hoverImg='';
  var hoverSrc=(p.gallery&&p.gallery.length)?p.gallery[0]:'/public/images/products/'+p.id+'/2.webp';
  var hasLocalGallery=p.gallery&&p.gallery.length>0;
  if(hasLocalGallery){
    hoverImg='<img src="'+hoverSrc+'" alt="" class="absolute inset-0 w-full h-full object-contain p-4 opacity-0 group-hover:opacity-100 transition-opacity duration-500 bg-gray-50">';
  }
